...
| 5 | **인프라 구축** | kubernetes를 이용한 MQTT 파이프라인 구축 | [🔗](https://github.com/jihwan77/school_project) |
| 6 | **보안 취약점** | Linux Copy-Fail (CVE-2026-31431) 취약점 분석 및 대응 | [🔗](https://github.com/jihwan77/Linux-Kernel-Copy-Fail-CVE-2026-31431-) |
